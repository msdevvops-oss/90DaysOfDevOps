...
5.chmod (-r,-w,-x,777): change file permission
6.chwon user:group : change file ownership
7.mv: move file to new destinations 
8.rm: remove a file
9.cp: copy file
10: head x: display line
tail x: display last line
rmdir: rmeove directory 

NETWORKING TROUBLESHOOTING COMMANDS:

1.ping: check connectivity
2.ipconfig: view network id
3.ns loopup: query DNS record
4.netstat -a: Show listening tcp and udp ports and corresponding programs
5.host: resolve domain names to IPs
